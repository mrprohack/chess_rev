...
void main() {
  test('accepts supported provider URLs and rejects deceptive hosts', () {
    ...
    expect(isSupportedGameUri(Uri.parse('https://lichess.org/analysis/abcdefgh')), isTrue);
    expect(isSupportedGameUri(Uri.parse('https://chess.com.attacker.example/game/170804338698')), isFalse);
  ...
  test('extracts the first supported URL from shared text', () {
    final uri = extractSupportedGameUri('Review https://lichess.org/abcdefgh please');
