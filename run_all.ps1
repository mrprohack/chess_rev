...
Start-Process powershell -ArgumentList "-ExecutionPolicy", "Bypass", "-NoExit", "-Command", "cd backend; .\venv\Scripts\python.exe main.py"
...
Write-Host "Backend URL: http://127.0.0.1:8000" -ForegroundColor Yellow
